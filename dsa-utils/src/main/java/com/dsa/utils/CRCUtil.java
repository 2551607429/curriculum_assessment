...
public class CRCUtil {
	...
	public static byte calcCrc8(byte[] data, int offset, int len, byte preval) {
	  ...
	  public static long calcCrc32(InputStream data) throws IOException
	  {
	...
	public static void main(String[] args) {
		System.out.println(calcCrc16("测试ccccc".getBytes()));
		System.out.println(calcCrc8("测试ccccc".getBytes()));
		byte[] data = "jianggujin".getBytes();
		   long result = calcCrc32(data);
		   System.err.println("32:"+result);
	}
}
